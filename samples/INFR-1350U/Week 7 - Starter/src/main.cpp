...
int main() {
	...
	// TODO: load textures 
	Texture2DData::sptr diffuseMap = Texture2DData::LoadFromFile("images/Stone_001_Diffuse.png"); //objects colour 
	Texture2DData::sptr diffuseMap2 = Texture2DData::LoadFromFile("images/sample.png"); //objects colour to mix between 
	Texture2DData::sptr specularMap = Texture2DData::LoadFromFile("images/Stone_001_Specular.png"); //how shiny/reflective  
