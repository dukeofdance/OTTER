...
int main() {
	...
	static const float points3[] = {
	-0.5f, -0.5f, 0.0f,
	0.5f, -0.5f, 0.0f,
	-0.5f, 0.5f, 0.0f
	};

	static const float colors3[] = {
		0.0f, 1.0f, 1.0f,
		1.0f, 0.0f, 1.0f,
		0.0f, 0.0f, 1.0f
	};
	...
	//VBO - Vertex buffer object
	VertexBuffer::sptr posVbo3 = VertexBuffer::Create();
	posVbo3->LoadData(points3, 9);
	VertexBuffer::sptr color_vbo3 = VertexBuffer::Create();
	color_vbo3->LoadData(colors3, 9);

	VertexArrayObject::sptr vao3 = VertexArrayObject::Create();
	vao3->AddVertexBuffer(posVbo3, {
		BufferAttribute(0, 3, GL_FLOAT, false, 0, NULL)
		});
	vao3->AddVertexBuffer(color_vbo3, {
		BufferAttribute(1, 3, GL_FLOAT, false, 0, NULL)
		});
