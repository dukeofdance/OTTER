...
int main() {
	...
	glm::mat4 transform2 = glm::translate(glm::mat4(1.0f), glm::vec3(-3.0f, 0.0f, 0.0f));
	transform = glm::translate(transform, glm::vec3(-2.0f, 0.0f, 0.0f));

	glm::mat4 transform3 = glm::mat4(1.0f);
	glm::mat4 transform4 = glm::translate(glm::mat4(1.0f), glm::vec3(3.0f, 0.0f, 0.0f));
	transform3 = glm::translate(transform, glm::vec3(-2.0f, 0.0f, 0.0f));
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS) {//TODO IGNORE THIS PLZ IT BROKEN :(
			transform3 = glm::translate(transform3, glm::vec3( 1.0f * dt, 0.0f, 0.0f));
			transform = glm::translate(transform3, glm::vec3( 1.0f * dt, 0.0f, 0.0f));
		}
		...
		if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS) {
			...
			transform = glm::translate(transform3, glm::vec3(0.0f, -1.0f * dt, 0.0f));
		}
		...
		if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS) {
			camera->SetOrtho(!camera->GetOrtho());
		}
				
		transform = glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(0, 1, 0));
		transform2 = transform * glm::translate(glm::mat4(1.0f), glm::vec3(-3, 0.0f, glm::sin(static_cast<float>(thisFrame))));

		transform3 = glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(1, 0, 0));

		transform4 = transform3 * glm::translate(glm::mat4(1.0f), glm::vec3(3, 0.0f, glm::sin(static_cast<float>(thisFrame))));
